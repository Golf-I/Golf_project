...
public interface BoardService {
	...
	public List<BoardVO> selectNotice(Criteria cri) throws Exception; // 공지사항 총 게시물 조회

	public List<BoardVO> selectQnA(Criteria cri) throws Exception; // 자주묻는질문 총 게시물 조회
	...
	public List<EventVO> selectEvent(Criteria cri) throws Exception; // 이벤트 총 게시물 조회
	...
	public List<EventVO> oneEvent(EventVO vo) throws Exception; // 이벤트 조회
