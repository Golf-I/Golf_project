...
<head>
    ...
    <title>store_inquiry</title>
    <link href="${pageContext.request.contextPath}/resources/css/store_inquiry.css" rel="stylesheet">
</head>
<body>
         ...
         <div class="store_inquiry">
            ...
            <div class="information">
                ...
                <div class="right_inf">
                    ...
                    <div class="box01">
						...
						골프아이와 함께 할 공급 및 판매자는 제휴 문의를 이용해 주시기 바랍니다.
						</p>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <p>상품유형</p>
                        <input type="text" name="brand" id="txt04">
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <p><span>*</span>담당자</p>
                        <input type="text" name="manager" id="txt05" required>
                    </td>

                    <td>
                        <p>부서</p>
                        <input type="text" name="department" id="txt06">
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <p>연락처</p>
                        <input type="text" name="contact" id="txt07">
                    </td>

                    <td>
                        <p><span>*</span>핸드폰</p>
                        <input type="text" name="phone" id="txt08" required>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <p><span>*</span>회사소개</p>
                        <textarea name="introduce" id="txt09" required></textarea>
                    </td>
                </tr>
        ...
        <div class="typing_m_01">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="typing01" name="company" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="typing02" name="address" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="typing04" name="brand">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="typing05" name="manager" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="typing06" name="department">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="typing07" name="contact">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="typing08" name="phone" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="typing09" name="introduce" required></textarea>
                    </td>
                </tr>
