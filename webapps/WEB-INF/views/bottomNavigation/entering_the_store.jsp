...
<head>
	...
	<script	src="${pageContext.request.contextPath}/resources/js/entering_the_store.js"></script>
</head>
<body>
   ...
   <section>
        ...
        <div class="menu">
         ...
         <div class="store_inquiry">
			...
			<form action="category/store" method="post" enctype="multipart/form-data" onsubmit="return formCheck();">
