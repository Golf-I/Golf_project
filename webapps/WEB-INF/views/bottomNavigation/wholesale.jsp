...
<head>
    ...
    <script	src="${pageContext.request.contextPath}/resources/js/wholesale.js"></script>
</head>
<body>
   ...
   <section>
        ...
        <div class="hallsale">
			...
			<form action="category/wholesale" method="post" enctype="multipart/form-data" onsubmit="return agreeCheck();">
