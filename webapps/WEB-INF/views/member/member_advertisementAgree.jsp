...
<body>
            ...
            <div class="box01">
                ...
                <div class="box02">
                    ...
                    <div class="txt03">
                        ...
                        <p>2) <span>SMS, MMS, 이메일, 푸쉬</span> : 웹 브라우저에서 마이페이지 > 프로필관리 확인/수정에서 변경할수 있습니다.</p>
                    </div>
    ...
    <section class="mobile">
        ...
        <div class="advertisement_m_box01">

            <p>광고성 정보 수신 동의</p>

            <div class="advertisement_line_m"></div>

            <p>[선택] 광고성 정보 수신 동의에 대한 약관</p>

            <div class="advertisement_m_box02">

                <div>

                    <p><span>${sessionScope.id}</span>은 회원님이 수집 및 이용에 동의한 개인 정보를 이용하여 SMS, MMS, 이메일, 푸시 알림 등 
                    	다양한 전자적 전송 매체를 통해 오전 8시부터 오후 9시까지 개인 맞춤형 광고 및 정보를 전송할 수 있습니다.
						본 동의는 거부하실 수 있으나, 거부 시 이벤트 및 프로모션 안내를 받아보실 수 없습니다.</p>

                    <p>광고성 정보 수신의 변경은</p>

                    <p>1) <span>골프아이</span> 고객센터(1577-000, help@naver.com)로 요청</p>

                    <p>1) <span>SMS, MMS, 이메일, 푸쉬 </span>: 웹 브라우저에서 마이페이지 > 프로필관리 확인/수정에서 변경할수 있습니다.</p>

                </div>
            </div>

            <input type="button" value="확인" id="advertisement_m_btn" onclick="javascript:window.close();">
        </div>
