...
<body>
	...
	<section class="web">
        ...
        <div class="withdrawal">
            ...
            <div class="box_wi">
                ...
                <div class="txt01">
                    ...
                    <div>
                        ...
                        <p>- 거래정보가 있는 경우, 전자상거래 등에서의 소비자 보호에 관한 법률에 따라 계약 또는 청약철회에 관한 기록, 
                        	대금결제 및 재화 등의 공급에 관한 기록은 5년동안 보존됩니다.</p>

                        <p>- 미사용 쿠폰은 회원탈퇴 후 사용하실 수 없습니다.</p>

                        <p>- 보유하셨던 포인트는 탈퇴와 함께 삭제되며 환불되지 않습니다.</p>

                        <p>- 회원탈퇴 후 서비스에 입력하신 상품문의 및 후기, 댓글은 삭제되지 않으며, 
                        	회원정보 삭제로 인해 작성자 본인을 확인할 수 없어 편집 및 삭제처리가 원천적으로 불가능 합니다.</p>
           ...
           <input type="submit" value="회원탈퇴" id="btn_wi">
	...
	<section class="mobile">
        ...
        <div class="withdrawal_m_line01"></div>
        ...
        <div class="agree_m_01">
            ...
            <div class="agree_txt_m_01">
                ...
                <div>
                    <p>- 회원탈퇴 시 회원전용 웹 서비스 이용이 불가합니다.</p>
                    <p>- 거래정보가 있는 경우, 전자상거래 등에서의 소비자 보호에 관한 법률에 따라 계약 또는 청약철회에 관한 기록, 대금결제 및 재화 등의 공급에 관한 기록은 5년동안 보존됩니다.</p>
                    <p>- 미사용 쿠폰은 회원탈퇴 후 사용하실 수 없습니다.</p>
                    <p>- 보유하셨던 포인트는 탈퇴와 함께 삭제되며 환불되지 않습니다.</p>
                    <p>- 회원탈퇴 후 서비스에 입력하신 상품문의 및 후기, 댓글은 삭제 되지 않으며, 회원정보 삭제로 인해 작성자 본인을 확인할 수 없어 편집 및 삭제처리가 원천적으로 불가능 합니다.</p>
                    <p>- 상품문의 및 후기, 댓글 삭제를 원하시는 경우에는 먼저 해당 게시물을 삭제하신 후 탈퇴를 신청하시기 바랍니다.</p>
                    <p>- 이미 결제가 완료된 건은 탈퇴로 취소되지 않습니다.</p>
                </div>
