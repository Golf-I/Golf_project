...
<html>
<head>
<title>네이버모바일로그인</title>
</head>
<body>
	<script type="text/javascript">
	
	  var naver_id_login_m = new naver_id_login_m("YisyoxafjYVqvrj6lctE", "mobilenaverlogin"); // "YOUR_CLIENT_ID", "YOUR_CALLBACK_URL"
	   
	  // 접근 토큰 값 출력
	  //alert(naver_id_login.oauthParams.access_token);
	  
	  // 네이버 사용자 프로필 조회 
	  naver_id_login_m.get_naver_userprofile("naverSignInCallback()");
	  ...
	  function naverSignInCallback() {
	    ...
	    //alert(naver_id_login.getProfileData('gender'));
		  ...
		  var id = naver_id_login_m.getProfileData('id_m');
		  var name = naver_id_login_m.getProfileData('name_m');
		  var sns = "naver";
