        ...
        <div class="confirmation_box">
            ...
            <div class="title_top">
                ...
                <div class="icon">
                    ...
                    <label for="link">
                        <img src="${pageContext.request.contextPath}/resources/img/reservation/link.png">
                    </label>

                    <div class="link_sheet">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/resources/img/reservation/band_link.png">
                        </a>
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/resources/img/reservation/facebook_link.png">
                        </a>
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/resources/img/reservation/kakao_link.png">
                        </a>
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/resources/img/reservation/twiter_link.png">
                        </a>
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/resources/img/reservation/line_link.png">
                        </a>
                    </div>


                    <a href="#">
                        <img src="${pageContext.request.contextPath}/resources/img/reservation/print.png">
                    </a>
            ...
            <div class="con_box">
                ...
                <table class="box01" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <div>
                                <p>왕복항공권(유류세 & TAX 포함), 무제한 그린피, 후지야 호텔 (2인1실), 전일정 식사
                                </p>
                            </div>
                        </td>
                    </tr>
                ...
                <div class="calendar">
                    ...
                    <table class="day_02" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td rowspan="2">
                                ...
                                <div class="paln02">
                                    ...
                                    <div class="img_box">
                                        <div>
                                            <img src="${pageContext.request.contextPath}/resources/img/reservation/two_day_01.png">
                                        </div>

                                        <div>
                                            <img src="${pageContext.request.contextPath}/resources/img/reservation/two_day_02.png">
                                        </div>

                                        <div>
                                            <img src="${pageContext.request.contextPath}/resources/img/reservation/two_day_03.png">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="day_03" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td rowspan="2">
                                ...
                                <div class="paln03">
                                    ...
                                    <p><span>[10:30]</span> 인천 국제공항 도착</p>
                                </div>
