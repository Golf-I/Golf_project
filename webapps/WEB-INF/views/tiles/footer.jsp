	...
	<div class="footer_middle">
		<div class="sns_zon">
			...
			<div class="sns">
				...
				<div class="blog">
					<a href="#"> <img
						src="${pageContext.request.contextPath}/resources/img/blog.png">
					</a>
				</div>
				...
				<div class="band">
					<a href="#"> <img
						src="${pageContext.request.contextPath}/resources/img/band.png">
					</a>
				</div>
			</div>
		</div>
	...
	<div class="footer_bottom_ex">
		<div class="footer_bottom">
			<div class="company">
				...
				<p>copyright 1300k.com.ALL RIGHTS RESERVED. 상품 사진을 포함한 모든 콘텐츠는
					저작권법 제 98조에 의거해 보호를 받고 있습니다.</p>
			</div>
			<!--회사-->
