...
<body>
    ...
    <div class="footer_top_ex">
		
		<div class="footer_top">
		
			<ul>
				<a href="company"><li><p>회사소개</p></li></a>
   	...
   	<div class="footer_line02"></div>

  	<div class="footer_middle_ex">
	...
	<div class="footer_middle">
		...
		<div class="sns_zon">
			...
			<div class="footer_logo">
				<a href="index">
					<img src="${pageContext.request.contextPath}/resources/img/footer_logo.png">
				</a>
			</div>
				...
				<div class="sns">
					...
					<div class="blog">
						<a href="#">
							<img src="${pageContext.request.contextPath}/resources/img/blog.png">
						</a>
					</div>
