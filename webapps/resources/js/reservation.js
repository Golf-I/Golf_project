		...
		$("#num01").change(function(){
			...
			for(var i=2; i<=each; i++){
				input += "<p>여행자정보"+ i + "</p>" +
						...
						"	id='last_name01' name='traveler_firstname' required>" +
						"<input type='text' size='10' maxlength='10' placeholder='성(예,GILDONG)'" +
						"	id='name01' name='traveler_lastname' required></td>" +
						"<td><p>연락처</p></td>" +
						"<td><input type='text' name='traveler_phone' id='traveler01_phone' required/></td>" +
						"</tr>" +
						"</table>" +
						"<br/><br/>";
			} // for
